...
RDEPEND=">=dev-haskell/aeson-0.6.1:=[profile?]
	>=dev-haskell/attempt-0.3.1.1:=[profile?] <dev-haskell/attempt-0.5:=[profile?]
	>=dev-haskell/aws-0.7.6.4:=[profile?]
	...
	>=dev-haskell/xml-conduit-1.0.1:=[profile?] <dev-haskell/xml-conduit-1.2:=[profile?]
	>=dev-lang/ghc-7.4.1:=
"
DEPEND="${RDEPEND}
