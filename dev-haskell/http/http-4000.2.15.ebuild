...
SLOT="0/${PV}"
KEYWORDS="~amd64 ~x86"
IUSE="conduit10 mtl1 network23 warn-as-error"
...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/case-insensitive-0.4 <dev-haskell/case-insensitive-1.3
		...
		mtl1? ( >=dev-haskell/mtl-2.0 <dev-haskell/mtl-2.3 ) )
	conduit10? ( test? ( >=dev-haskell/conduit-0.4 <dev-haskell/conduit-1.1 ) )
	!conduit10? ( test? ( >=dev-haskell/conduit-1.1 <dev-haskell/conduit-1.2
