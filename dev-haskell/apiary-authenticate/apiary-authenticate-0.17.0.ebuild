...
RDEPEND=">=dev-haskell/apiary-0.17:=[profile?] <dev-haskell/apiary-0.18:=[profile?]
	>=dev-haskell/apiary-clientsession-0.17:=[profile?] <dev-haskell/apiary-clientsession-0.18:=[profile?]
