...
RDEPEND=">=dev-haskell/apiary-1.4:=[profile?] <dev-haskell/apiary-1.5:=[profile?]
	>=dev-haskell/apiary-session-1.4:=[profile?] <dev-haskell/apiary-session-1.5:=[profile?]
	>=dev-haskell/authenticate-1.3.2.10:=[profile?] <dev-haskell/authenticate-1.4:=[profile?]
	...
	dev-haskell/types-compat:=[profile?]
	>=dev-haskell/wai-3.0:=[profile?] <dev-haskell/wai-3.1:=[profile?]
	dev-haskell/web-routing:=[profile?]
	>=dev-lang/ghc-7.6.1:=
"
DEPEND="${RDEPEND}
