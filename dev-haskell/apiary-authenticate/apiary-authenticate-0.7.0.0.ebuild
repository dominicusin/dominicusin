...
RDEPEND=">=dev-haskell/apiary-0.7:=[profile?] <dev-haskell/apiary-0.8:=[profile?]
	>=dev-haskell/apiary-clientsession-0.7:=[profile?] <dev-haskell/apiary-clientsession-0.8:=[profile?]
