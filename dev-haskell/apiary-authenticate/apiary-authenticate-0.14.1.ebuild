...
RDEPEND=">=dev-haskell/apiary-0.14:=[profile?] <dev-haskell/apiary-0.16:=[profile?]
	>=dev-haskell/apiary-clientsession-0.9:=[profile?] <dev-haskell/apiary-clientsession-0.14:=[profile?]
