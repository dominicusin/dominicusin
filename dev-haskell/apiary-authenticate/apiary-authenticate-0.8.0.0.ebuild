...
RDEPEND=">=dev-haskell/apiary-0.8:=[profile?] <dev-haskell/apiary-0.9:=[profile?]
	>=dev-haskell/apiary-clientsession-0.8:=[profile?] <dev-haskell/apiary-clientsession-0.9:=[profile?]
