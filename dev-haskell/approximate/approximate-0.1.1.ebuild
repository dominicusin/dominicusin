...
RDEPEND=">=dev-haskell/binary-0.5:=[profile?] <dev-haskell/binary-0.8:=[profile?]
	...
	>=dev-haskell/generic-deriving-1.4:=[profile?] <dev-haskell/generic-deriving-1.6:=[profile?]
	...
	dev-haskell/log-domain:=[profile?]
	>=dev-haskell/pointed-3:=[profile?] <dev-haskell/pointed-4:=[profile?]
