...
RDEPEND=">=dev-haskell/binary-0.5:=
	...
	|| ( ( >=dev-haskell/aeson-0.6:= <dev-haskell/aeson-0.7:= )
		|| ( ( >=dev-haskell/aeson-0.7:= <dev-haskell/aeson-0.8:= )
			( >=dev-haskell/aeson-0.8:= <dev-haskell/aeson-0.9:= ) ) )
"
DEPEND="${RDEPEND}
	>=dev-haskell/cabal-1.16.0
	test? ( >=dev-haskell/hunit-1.2 <dev-haskell/hunit-1.3
		>=dev-haskell/process-extras-0.2 <dev-haskell/process-extras-0.3
		>=dev-haskell/tasty-golden-2.2.0.2 <=dev-haskell/tasty-golden-2.3
		|| ( ( >=dev-haskell/tasty-0.7 <dev-haskell/tasty-0.8 )
			|| ( ( >=dev-haskell/tasty-0.8 <dev-haskell/tasty-0.9 )
				( >=dev-haskell/tasty-0.9 <dev-haskell/tasty-0.10 ) ) )
		|| ( ( >=dev-haskell/tasty-hunit-0.2 <dev-haskell/tasty-hunit-0.3 )
