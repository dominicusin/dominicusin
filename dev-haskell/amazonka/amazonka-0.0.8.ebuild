...
RDEPEND=">=dev-haskell/amazonka-core-0.0.8:=[profile?] <dev-haskell/amazonka-core-0.0.9:=[profile?]
	...
	>=dev-haskell/monad-control-0.3.2:=[profile?] <dev-haskell/monad-control-4:=[profile?]
