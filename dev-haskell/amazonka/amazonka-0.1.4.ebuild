...
RDEPEND=">=dev-haskell/amazonka-core-0.1.4:=[profile?] <dev-haskell/amazonka-core-0.1.5:=[profile?]
	...
	>=dev-haskell/monad-control-0.3.2:=[profile?] <dev-haskell/monad-control-1:=[profile?]
