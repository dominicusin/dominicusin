...
RDEPEND=">=dev-haskell/apiary-1.2:=[profile?] <dev-haskell/apiary-1.5:=[profile?]
	>=dev-haskell/apiary-cookie-1.2:=[profile?] <dev-haskell/apiary-cookie-1.5:=[profile?]
	>=dev-haskell/apiary-session-1.2:=[profile?] <dev-haskell/apiary-session-1.5:=[profile?]
