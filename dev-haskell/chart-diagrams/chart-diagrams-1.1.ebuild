...
RDEPEND=">=dev-haskell/blaze-svg-0.3.3:=[profile?]
	...
	>=dev-haskell/diagrams-postscript-0.7:=[profile?] <dev-haskell/diagrams-postscript-0.8:=[profile?]
	>=dev-haskell/diagrams-svg-0.8:=[profile?] <dev-haskell/diagrams-svg-0.9:=[profile?]
