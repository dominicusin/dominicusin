...
RDEPEND=">dev-haskell/aeson-0.7.0.6:=[profile?] <dev-haskell/aeson-0.9:=[profile?]
	...
	>=dev-haskell/bifunctors-4.1:=[profile?] <dev-haskell/bifunctors-5:=[profile?]
	>=dev-haskell/case-insensitive-1.2:=[profile?] <dev-haskell/case-insensitive-2:=[profile?]
