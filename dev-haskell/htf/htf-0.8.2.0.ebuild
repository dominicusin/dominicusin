...
RDEPEND=">=dev-haskell/cpphs-1.12:=[profile?]
	...
	>=dev-haskell/haskell-src-exts-1.11:=[profile?] <dev-haskell/haskell-src-exts-1.12:=[profile?]
	>=dev-haskell/hunit-1.2:=[profile?] <dev-haskell/hunit-1.3:=[profile?]
	>=dev-haskell/mtl-1.1:=[profile?] <dev-haskell/mtl-2.1:=[profile?]
	>=dev-haskell/quickcheck-2.3:2=[profile?] <dev-haskell/quickcheck-2.4:2=[profile?]
