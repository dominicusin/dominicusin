...
RDEPEND=">=dev-haskell/fclabels-1.0:=[profile?] <dev-haskell/fclabels-1.2:=[profile?]
	>=dev-haskell/hashable-1.1:=[profile?] <dev-haskell/hashable-1.3:=[profile?]
	>=dev-haskell/hashtables-1.0:=[profile?] <dev-haskell/hashtables-1.2:=[profile?]
	>=dev-lang/ghc-7.4.1:=
	more-pp? ( >=dev-haskell/blaze-html-0.5:=[profile?] <dev-haskell/blaze-html-0.7:=[profile?]
