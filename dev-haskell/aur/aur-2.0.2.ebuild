...
RDEPEND=">=dev-haskell/aeson-0.7:=[profile?] <dev-haskell/aeson-1:=[profile?]
	>=dev-haskell/aeson-pretty-0.7:=[profile?] <dev-haskell/aeson-pretty-1:=[profile?]
	>=dev-haskell/lens-4.2:=[profile?] <dev-haskell/lens-5:=[profile?]
	...
	>=dev-haskell/wreq-0.1:=[profile?] <dev-haskell/wreq-0.3:=[profile?]
	>=dev-lang/ghc-7.8.2:=
"
DEPEND="${RDEPEND}
