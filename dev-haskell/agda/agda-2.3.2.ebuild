...
RDEPEND=">=dev-haskell/binary-0.4.4:=[profile?] <dev-haskell/binary-0.6:=[profile?]
	...
	>=dev-haskell/hashtables-1.0:=[profile?] <dev-haskell/hashtables-1.1:=[profile?]
	>=dev-haskell/haskeline-0.6.3.2:=[profile?] <dev-haskell/haskeline-0.8:=[profile?]
	>=dev-haskell/haskell-src-exts-1.9.6:=[profile?] <dev-haskell/haskell-src-exts-1.14:=[profile?]
