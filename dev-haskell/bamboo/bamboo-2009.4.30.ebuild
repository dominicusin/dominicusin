...
RDEPEND="dev-haskell/ansi-wl-pprint:=[profile?]
	...
	>=dev-haskell/hack-2009.4.30:=[profile?]
	>=dev-haskell/hack-contrib-2009.4.30:=[profile?]
	>=dev-haskell/hcheat-2008.11.6:=[profile?]
	>=dev-haskell/kibro-0.4.2:=[profile?]
	dev-haskell/missingh:=[profile?]
	>=dev-haskell/mps-2008.11.6:=[profile?]
