...
RDEPEND=">=dev-haskell/blaze-builder-0.3:=[profile?] <dev-haskell/blaze-builder-0.5:=[profile?]
	>=dev-haskell/blaze-html-0.7:=[profile?] <dev-haskell/blaze-html-0.9:=[profile?]
	>=dev-haskell/blaze-markup-0.6:=[profile?] <dev-haskell/blaze-markup-0.8:=[profile?]
	>=dev-haskell/bytestring-read-0.2:=[profile?] <dev-haskell/bytestring-read-0.3:=[profile?]
	...
	>=dev-haskell/http-date-0.0:=[profile?] <dev-haskell/http-date-0.1:=[profile?]
	...
	>=dev-haskell/types-compat-0.1:=[profile?] <dev-haskell/types-compat-0.2:=[profile?]
	...
	>=dev-haskell/web-routing-0.6:=[profile?] <dev-haskell/web-routing-0.7:=[profile?]
	>=dev-lang/ghc-7.8.2:=
"
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/hunit-1.2 <dev-haskell/hunit-1.3
		...
		>=dev-haskell/wai-extra-3.0 <dev-haskell/wai-extra-3.1 )
"
