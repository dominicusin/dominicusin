...
RDEPEND=">=dev-haskell/aeson-0.6.2.1:=[profile?] <dev-haskell/aeson-0.9:=[profile?]
	...
	>=dev-haskell/reroute-0.2:=[profile?] <dev-haskell/reroute-0.3:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/hspec-wai-0.5 <dev-haskell/hspec-wai-0.6
		>=dev-haskell/hspec2-0.4 <dev-haskell/hspec2-0.5 )
"
