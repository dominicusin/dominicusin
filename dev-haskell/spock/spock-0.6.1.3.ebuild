...
RDEPEND=">=dev-haskell/aeson-0.6.2.1:=[profile?] <dev-haskell/aeson-0.8:=[profile?]
	...
	>=dev-haskell/wai-3.0:=[profile?] <dev-haskell/wai-4.0:=[profile?]
	>=dev-haskell/wai-extra-3.0:=[profile?] <dev-haskell/wai-extra-4.0:=[profile?]
	>=dev-haskell/warp-3.0:=[profile?] <dev-haskell/warp-4.0:=[profile?]
