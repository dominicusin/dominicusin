...
RDEPEND=">=dev-haskell/aeson-0.6.2.1:=[profile?] <dev-haskell/aeson-0.9:=[profile?]
	...
	>=dev-haskell/hlist-0.3:=[profile?]
	>=dev-haskell/hspec-wai-0.5:=[profile?] <dev-haskell/hspec-wai-0.6:=[profile?]
	>=dev-haskell/hspec2-0.4:=[profile?] <dev-haskell/hspec2-0.5:=[profile?]
	...
	>=dev-haskell/reroute-0.1:=[profile?] <dev-haskell/reroute-0.2:=[profile?]
