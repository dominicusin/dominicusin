...
RDEPEND=">=dev-haskell/attempt-0.3.1.1:=[profile?] <dev-haskell/attempt-0.5:=[profile?]
	...
	>=dev-haskell/case-insensitive-0.2:=[profile?] <dev-haskell/case-insensitive-1.1:=[profile?]
	...
	>=dev-haskell/http-conduit-1.6:=[profile?] <dev-haskell/http-conduit-1.10:=[profile?]
