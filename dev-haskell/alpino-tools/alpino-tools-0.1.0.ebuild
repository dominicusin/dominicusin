...
RDEPEND=">=dev-haskell/bytestring-lexing-0.2.1:=[profile?]
	>=dev-haskell/enumerator-0.4.8:=[profile?] <dev-haskell/enumerator-0.5:=[profile?]
	>=dev-haskell/hexpat-pickle-0.4:=[profile?]
	>=dev-haskell/mtl-2.0.1.0:=[profile?]
	>=dev-haskell/random-1.0.0.3:=[profile?]
	>=dev-haskell/random-shuffle-0.0.2:=[profile?]
